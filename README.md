...
A simple desktop application to check vegetable prices from the market using a graphical user interface.
...
2. Ensure Python 3.13.4 is installed on your system
...
- Integration with real marketplace API for live prices
- Display price history and trends
- Filter by region/mandi location
- Save favorite vegetables
- Price comparison across different maekwtplaces
